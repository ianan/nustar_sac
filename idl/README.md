...
* [*example_nslct2.pro*](https://github.com/ianan/nsigh/blob/master/idl/example_nslct2.pro) - Load in evt, hk and chu files and plot time profiles of them - this time with spatial xy filtering
