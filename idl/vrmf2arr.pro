;
; VRMF2ARR - normalize an RMF (decompress var length arrays if desired)
;
; Originally from https://lost-contact.mit.edu/afs/physics.wisc.edu/home/craigm/lib/idl/spectral/vrmf2arr.pro
